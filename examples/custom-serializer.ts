...
async function main() {
  ...
  const store1 = new KeyvNedbStore(".cache/serializer-example.nedb.yaml", {
  ...
  console.log("  startDate is Date instance:", retrievedEvent.startDate instanceof Date);
  ...
  const store3 = new KeyvNedbStore(".cache/no-serializer-example.nedb.yaml", {
    serializer: {
